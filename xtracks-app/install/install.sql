CREATE DATABASE IF NOT EXISTS %install_db%;

CREATE TABLE IF NOT EXISTS %install_db%.`202_version` (
					  `version` varchar(50) NOT NULL
					) ENGINE=MyISAM DEFAULT CHARSET=latin1;

INSERT IGNORE INTO %install_db%.`202_version` SET `version`='1.0.2';

CREATE TABLE IF NOT EXISTS %install_db%.`202_sessions` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_users_log` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_users` (
  `user_id` mediumint(8) unsigned NOT NULL auto_increment,
  `user_name` varchar(50) NOT NULL,
  `user_pass` char(32) NOT NULL,
  `user_email` varchar(100) NOT NULL,
  `addCode` varchar(10) DEFAULT NULL,
  `cb_user` varchar(40) DEFAULT NULL,
  `cb_pass` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_users_pref` (
  `user_id` mediumint(8) unsigned NOT NULL,
 ...
 CREATE TABLE IF NOT EXISTS %install_db%.`202_export_adgroups` (
 ...
 CREATE TABLE IF NOT EXISTS %install_db%.`202_export_campaigns` (
				  `export_session_id` mediumint(8) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_export_keywords` (
				  `export_session_id` mediumint(8) unsigned NOT NULL,
				  `export_campaign_id` mediumint(8) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_export_sessions` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_export_textads` (
				  `export_session_id` mediumint(8) unsigned NOT NULL,
				  `export_campaign_id` mediumint(8) unsigned NOT NULL,
				  `export_adgroup_id` mediumint(8) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_aff_networks` (
...
INSERT INTO %install_db%.`202_aff_networks`
(user_id, aff_network_name, aff_network_time)
VALUES (1, 'Clickbooth', NOW());

CREATE TABLE IF NOT EXISTS %install_db%.`202_browsers` (
  `browser_id` tinyint(1) unsigned NOT NULL AUTO_INCREMENT,
  `browser_name` varchar(50) NOT NULL,
  PRIMARY KEY (`browser_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS %install_db%.`202_charts` (
  `chart_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `chart_xml` mediumtext NOT NULL,
  PRIMARY KEY (`chart_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS %install_db%.`202_clicks` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 /*!50100 PARTITION BY RANGE (click_time) (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_clicks_advance` (
  `click_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_clicks_counter` (
  `click_id` bigint(20) unsigned NOT NULL auto_increment,
  PRIMARY KEY  (`click_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS %install_db%.`202_clicks_record` (
  `click_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_clicks_site` (
  `click_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_clicks_spy` (
  `click_id` bigint(20) unsigned NOT NULL,
  `user_id` mediumint(8) unsigned NOT NULL,
  `aff_campaign_id` mediumint(8) unsigned NOT NULL,
  `landing_page_id` mediumint(8) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_delayed_sqls` (
  `delayed_sql` text NOT NULL,
  `delayed_time` int(10) unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS %install_db%.`202_ips` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_keywords` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_landing_pages` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_last_ips` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_locations` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_locations_block` (
  `location_id` mediumint(8) unsigned NOT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 /*!50100 PARTITION BY RANGE (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_locations_city` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_locations_coordinates` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_locations_country` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_locations_region` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_platforms` (
  `platform_id` tinyint(1) unsigned NOT NULL AUTO_INCREMENT,
  `platform_name` varchar(50) NOT NULL,
  PRIMARY KEY (`platform_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS %install_db%.`202_ppc_accounts` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_ppc_networks` (
...
INSERT IGNORE INTO %install_db%.`202_ppc_networks` VALUES
(1,1,0,'Google Adwords',1259093126),
(2,1,0,'Microsoft adCenter',1259093135),
(3,1,0,'Yahoo',1259093269);

CREATE TABLE IF NOT EXISTS %install_db%.`202_site_domains` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_site_urls` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_sort_breakdowns` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_sort_ips` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_sort_keywords` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_sort_landing_pages` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_sort_referers` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_sort_text_ads` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_summary_overview` (
				  `user_id` mediumint(8) unsigned NOT NULL,
				  `aff_campaign_id` mediumint(8) unsigned NOT NULL,
				  `landing_page_id` mediumint(8) unsigned NOT NULL,
				  `ppc_account_id` mediumint(8) unsigned NOT NULL,
				...
				) ENGINE=MyISAM DEFAULT CHARSET=latin1 /*!50100 PARTITION BY RANGE (click_time) (PARTITION p32 VALUES LESS THAN (1247641200) ENGINE = MyISAM,
					PARTITION p33 VALUES LESS THAN (1248850800) ENGINE = MyISAM,
					PARTITION p34 VALUES LESS THAN (1250060400) ENGINE = MyISAM,
					PARTITION p35 VALUES LESS THAN (1251270000) ENGINE = MyISAM,
					PARTITION p36 VALUES LESS THAN (1252479600) ENGINE = MyISAM,
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_text_ads` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_trackers` (
...
CREATE TABLE IF NOT EXISTS %install_db%.`202_rotations` (
			  `aff_campaign_id` mediumint(8) unsigned NOT NULL,
			  `rotation_num` tinyint(4) NOT NULL,
			  PRIMARY KEY (`aff_campaign_id`)
			) ENGINE=MEMORY DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS %install_db%.`202_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `var_name` varchar(25) DEFAULT NULL,
  `var_value` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_var` (`user_id`,`var_name`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

INSERT IGNORE INTO %install_db%.`202_browsers` (`browser_id`, `browser_name`) VALUES
(1, 'Internet Explorer'),
(2, 'Firefox'),
(3, 'Konqueror'),
(4, 'Netscape'),
...
INSERT IGNORE INTO %install_db%.`202_platforms` (`platform_id`, `platform_name`) VALUES
(1, 'Windows'),
(2, 'Macintosh'),
(3, 'Linux'),
(4, 'OS/2'),
