...
//show tracking code
	...
	if ($_POST['method_of_promotion'] == 'directlink') { 
		...
		$destination_url = 'http://' . $_SERVER['SERVER_NAME'] . '/redirect/dl.php?t202id=' . $tracker_id_public . '&t202kw=';
		...
		printf('<b>Destination URL:</b>
			...
			always make sure to update it with a new XTracks destination.
            You should have a unique XTracks destination URL for each different above configuration you use.<br/><br/>
...
<p>It is extremely important whenever you modify your PPC campaign, if you are to change your CPC on your bids for instance, you must update it with a new unique XTracks destination URL. 
If you change your CPC and use a old destination URL, XTracks will think the CPC is set to whatever, your last unique destination URL had its CPC set to. </p>
