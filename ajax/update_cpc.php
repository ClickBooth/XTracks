...
<table style="margin: 0px auto;">
	...
	<tr>
		<td class="left_caption"><img src="/xtracks-img/icons/16x16/exclamation.png" align="right"></td>
		<td>
			<p>
	...
	<tr valign="middle">
		<td colspan="2" style="text-align: center;"><button onclick="update_cpc2();">Update My CPC</button> <img id="update_cpc2_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/></td>
	</tr>
</table
