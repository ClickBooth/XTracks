<? include_once($_SERVER['DOCUMENT_ROOT'] . '/xtracks-app/bootstrap.php'); 
	...
	//the pixel
	$pixel = '<img height="1" width="1" border="0" style="display: none;" src="http://'.$_SERVER['SERVER_NAME'].'/static/px.php?acip='.$html['aff_campaign_id_public'].'"/>';
	
	//post back url
	$postback = 'http://'.$_SERVER['SERVER_NAME'].'/static/pb.php?acip='.$html['aff_campaign_id_public'].'&subid=';
