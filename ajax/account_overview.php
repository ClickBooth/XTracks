...
for($x = 0; $x < 2; $x++) { 
	...
	//grab the variables
		if ($x ==0) { $click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND aff_campaign_id='".$mysql['aff_campaign_id']."'  AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=0"; }
		else { $click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND landing_page_id='".$mysql['landing_page_id']."'  AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=1"; }
	...
	//mysql escape the vars
			...
			//grab the variables
				$click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND aff_campaign_id='".$mysql['aff_campaign_id']."' AND landing_page_id='".$mysql['landing_page_id']."' AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=1"; 
				$click_result = _mysql_query($click_sql) ; //($click_sql);
				$click_row = mysql_fetch_assoc($click_result);
...
for($x = 0; $x < 2; $x++) { 
	...
	//ON THE FIRST RUN, GET THE TOTAL OF NO PPC ACCOUNTS, and then FOR THE INDIV PPC ACCOUNTS	
		...
		//grab the variables                                                        
			if ($x ==0) { $click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND aff_campaign_id='".$mysql['aff_campaign_id']."' AND ppc_account_id='0' AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=0"; }
			else { $click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND landing_page_id='".$mysql['landing_page_id']."'  AND ppc_account_id='0'AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=1"; }
			$click_result = _mysql_query($click_sql) ; //($click_sql);
			$click_row = mysql_fetch_assoc($click_result);
	...
	//grab theppc accounts to display
		...
		//grab the variables                                                        
			if ($x ==0) { $click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND aff_campaign_id='".$mysql['aff_campaign_id']."' AND ppc_account_id='".$mysql['ppc_account_id']."' AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=0"; }
			else { $click_sql = "SELECT COUNT(*) AS clicks, AVG(click_cpc) AS avg_cpc, SUM(click_lead) AS leads, SUM(click_lead * click_payout) AS income FROM 202_clicks WHERE user_id='".$mysql['user_id']."' $click_filtered AND landing_page_id='".$mysql['landing_page_id']."'  AND ppc_account_id='".$mysql['ppc_account_id']."'AND click_time > ".$mysql['from'] ." AND click_time <= ".$mysql['to']." AND click_alp=1"; }
			$click_result = _mysql_query($click_sql) ; //($click_sql);
			$click_row = mysql_fetch_assoc($click_result);
