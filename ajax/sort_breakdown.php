...
//grab breakdown report	
	...
	<table cellpadding="0" cellspacing="1" class="m-stats">
		<tr>   
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_order']; ?>');">Time</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_clicks_order']; ?>');">Clicks</a></th> 
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_leads_order']; ?>');">Leads</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_su_ratio_order']; ?>');">Avg S/U</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_payout_order']; ?>');">Avg Payout</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_epc_order']; ?>');">Avg EPC</a></th> 
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_avg_cpc_order']; ?>');">Avg CPC</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_income_order']; ?>');">Income</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_cost_order']; ?>');">Cost</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_net_order']; ?>');">Net</a></th>
			<th><a class="onclick_color" onclick="loadContent('/ajax/sort_breakdown.php','','<? echo $html['sort_breakdown_roi_order']; ?>');">ROI</a></th>
		</tr>  
