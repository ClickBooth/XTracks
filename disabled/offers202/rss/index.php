		...
		<td>
			...
			<table class="setup-table" cellpadding="0" cellspacing="0" style="margin: 0px;">
				...
				<tr>
					...
					<td><? echo "<a href='".TRACKING202_API_URL."/offers202'>".TRACKING202_API_URL."/offers202</a>"; ?></td>
				</tr>
				<tr>
					<td>Ringtones Offers, All Networks</th>
					<td><? echo "<a href='".TRACKING202_API_URL."/offers202?q=ringtones'>".TRACKING202_API_URL."/offers202?q=ringtones</a>"; ?></td>
				</tr>
				<tr>
					<td>Credit Report Offers, All Networks</th>
					<td><? echo "<a href='".TRACKING202_API_URL."/offers202?q=credit+report'>".TRACKING202_API_URL."/offers202?q=credit+report</a>"; ?></td>
				</tr>
			</table>
		</td>
	</tr>
