	...
	<? } else { ?>
		...
		<form method="post" action="">
			...
			<table class="config" cellspacing="0" cellpadding="5" style="margin: 0px auto;" >
				<tr><td colspan="2" style="text-align: center;">Please enter your username and e-mail address.<br/>You will receive a new password via e-mail to <a href="/xtracks-login.php">login</a> with.</td></tr>
				<tr><td/></tr>
				 <tr>
					<th>Username:</th>
