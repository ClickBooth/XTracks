		...
		<td>
				...
				<table style="margin: 0px auto;">
					<tr>
						<td colspan="2" style="width: 400px;">
							<h3 class="green">1st - Add Pay-Per-Click Networks</h3>
							<p style="text-align: justify;">What ppc companies do you use? Example: Yahoo SearchMarketing, MSN Adcenter, Google Adwords, etc etc. First add what PPC networks you use, then follow by adding your accounts to the networks you use.</p>
						</td>
					</tr>
					<tr><td/><br/></tr>
					<tr>
			...
			<form method="post" action="<? if ($delete_success == true) { echo $_SERVER['REDIRECT_URL']; }?>" style>
				<table style="margin-top: 35px;">
					<tr>
						<td colspan="2" style="width: 400px;">
							<h3 class="green">2nd - Add Individual Accounts</h3>
							<p style="text-align: justify;">Here you add each individual account you have for each PPC network you use.  For instance, if you have two Yahoo Accounts, you can add them both here.  This way we can track how each individual ppc account, on each network is doing.</p>
						</td>
					</tr>
					<tr><td/><br/></tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<? if ($editing == true) { ?>
								<input type="submit" value="Cancel" style="display: inline; margin-left: 10px;" onclick="window.location='/setup/ppc_accounts.php'; return false; "/>
							<? } ?>
						</td>
					</tr>
				</table>
