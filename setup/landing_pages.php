...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!$error) { 
		...
		if ($editing == true) {
			...
			header('location: /setup/landing_pages.php');        
		}
				...
				<td>
                    ...
                    <tr>
						...
						<td>
							...
							<? if ($editing == true) { ?>
								<input type="submit" value="Cancel" style="display: inline; margin-left: 10px;" onclick="window.location='/setup/landing_pages.php'; return false; "/>   
							<? } ?>
						</td>
					</tr>
				</table>
