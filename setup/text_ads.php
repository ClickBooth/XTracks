...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!$error) {
		...
		if ($editing == true) {
			header('location: /setup/text_ads.php');
...
<div id="info">
    <h2>Text Ad Setup</h2>
	Here is where you enter in your text ad information. If you have to many text-ads and do not want to enter them all, you can skip this step.
</div>
...
document.observe('dom:loaded', function(){
    // Select Clickbooth on load.
    load_aff_campaign_id(1);
});
        ...
        <td>
			...
			<tr>
				...
				<tr id="lp_aff_network" <? if ($html['text_ad_type'] == '1') { echo ' style="display:none;"'; } ?>>
						...
						<td>
							<img id="aff_network_id_div_loading" src="/xtracks-img/loader-small.gif"/>
					...
					<tr id="lp_aff_campaign" <? if ($html['text_ad_type'] == '1') { echo ' style="display:none;"'; } ?>>
                        ...
                        <td>
							<img id="aff_campaign_id_div_loading" src="/xtracks-img/loader-small.gif" style="display: none;"/>
					...
					<tr valign="top">
						...
						<td>
							...
							<? if ($editing == true or $_GET['copy_text_ad_id'] != '') { ?>
								<button  style="display: inline; margin-left: 10px;" onclick="window.location='/setup/text_ads.php'; return false; ">Cancel</button>
							<? } ?>
						</td>
					</tr>
				</table>
