				...
				<table style="margin: 0px auto;">    
					<tr>
						<td colspan="2" style="width: 400px;">
							...
							<p style="text-align: justify;">What affiliate companies do you use? Example: CPAEmpire, Copeac, Commission Junction, etc etc.  Add them by typing in their name and hitting submit.</p>
						</td>
					</tr>
					<tr><td/><br/></tr>
					<tr>
