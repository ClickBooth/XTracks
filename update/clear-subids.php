...
<div id="info">
	...
	Well if you accidently uploaded all of your subids, instead of only the converted subids, you can delete them all here, and then reupload again! 
</div>
	...
	<table style="margin: 5px auto;">
		<tr>
			...
			<td><img id="clear_subids_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/></td>
		</tr>
	</table>           
