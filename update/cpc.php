...
<div id="info">
	...
	Because XTracks assumes that you are paying full CPC each time, we understand you won't be paying this each time.  So to refine your stats you can update your old history's cpc to make them more accurate.  Simply choose your setup below to update your cpc for a specific time period, and a specific set of variables.
</div>
	...
	<form id="cpc_form" method="post">
		<table class="setup">
			...
			<tr  id="tracker_aff_network" >
				...
				<td>
	                    <img id="aff_network_id_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
			...
			<tr id="tracker_aff_campaign">
				...
				<td>
					<img id="aff_campaign_id_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
			...
			<tr  id="tracker_method_of_promotion">
				...
				<td>
					<img id="method_of_promotion_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
			...
			<tr>
				...
				<td>
					<img id="text_ad_id_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
			...
			<tr valign="top">
				...
				<td>
					<img id="ad_preview_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
			...
			<tr>
				...
				<td>
					<img id="ppc_network_id_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
			...
			<tr>
				...
				<td>
					<img id="ppc_account_id_div_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/>
	...
	<table style="margin: 5px auto;">
		<tr>
			...
			<td><img id="update_cpc_loading" style="display: none;" src="/xtracks-img/loader-small.gif"/></td>
		</tr>
	</table>           
