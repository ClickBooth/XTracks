...
# replace excelfile.xls with whatever you want the filename to default to
	header("Content-Disposition: attachment; filename=XT_visitors_".time().".xls");
...
//get stuff
	...
	$db_table = "202_clicks";
	$query = query($command, $db_table, true, true, true, '  ORDER BY 202_clicks.click_id DESC ', $_POST['offset'], true, false);
