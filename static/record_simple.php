...
$outbound_site_url = 'http://'.$_SERVER['SERVER_NAME'].'/redirect/pci.php?pci='.$click_id_public;
...
if ($cloaking_on == true) {
	...
	$cloaking_site_url = 'http://'.$_SERVER['SERVER_NAME'] . '/redirect/cl.php?pci=' . $click_id_public;
...
$old_lp_site_url = 'http://'.$_SERVER['SERVER_NAME'].'/redirect/lp.php\\\?lpip='.$landing_page_id_public;  
